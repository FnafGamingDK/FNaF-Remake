...
void mousePressed() {
  ...
  int y = mouseY;
  if (InGame == false) {
    if(i == 1) NightX = new SoundFile(this, "Night1.wav");
    //(i == 2) NightX = new SoundFile(this, "Night2.wav");
    //(i == 3) NightX = new SoundFile(this, "Night3.wav");
    //(i == 4) NightX = new SoundFile(this, "Night4.wav");
    //(i == 5) NightX = new SoundFile(this, "Night5.wav");
    if (MainMenu == true) {
